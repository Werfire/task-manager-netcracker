(function (global, factory) {
    ...
    var Push = function () {
        var self = this, isUndefined = function (obj) {
                return obj === undefined
            }, isString = function (obj) {
                return typeof obj === "string"
            }, isFunction = function (obj) {
                return obj && {}.toString.call(obj) === "[object Function]"
            }, currentId = 0, incompatibilityErrorMessage = "PushError: push.js is incompatible with browser.",
            notifications = {}, lastWorkerPath = null, closeNotification = function (id) {
                var errored = false, notification = notifications[id];
                ...
                if (typeof notification !== "undefined") {
                    var id = addNotification(notification), wrapper = prepareNotification(id, options);
